...
public class IssuingApiClientReferenceAppMain {
  ...
  private static final IssuingAuthorizationManagementService authorizationManagementService =
      new IssuingAuthorizationManagementService();

  /** The Constant cardControlsService. */
  private static final IssuingCardControlsService cardControlsService =
      new IssuingCardControlsService();

  /** The Constant cardIssuanceService. */
  private static final IssuingCardIssuanceService cardIssuanceService =
      new IssuingCardIssuanceService();

  /** The Constant cardManagementService. */
  private static final IssuingCardManagementService cardManagementService =
      new IssuingCardManagementService();

  /** The Constant transactionManagementService. */
  private static final IssuingTransactionManagementService transactionManagementService =
      new IssuingTransactionManagementService();
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length == 0 || "list".equalsIgnoreCase(args[0])) {
      ...
      // "authentication-token", "update-pin"
      // , "get-acq-controls", "update-acq-card-controls",

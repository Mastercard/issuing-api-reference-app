...
/**
 * The Class AuthTokenIntent.
 */
public final class AuthTokenIntent {

    private AuthTokenIntent() {
    }

    /** The Constant PIN_RESET. */
    ...
    /** The Constant MINI_STATEMENT. */
    public static final String MINI_STATEMENT = "MINI_STATEMENT";

    /** The Constant PURCHASE. */
    /** public static final String PURCHASE = "PURCHASE"; */

    /** The Constant TRANSFER_DEBIT. */
    /** public static final String TRANSFER_DEBIT = "TRANSFER_DEBIT"; */

    /** The Constant TRANSFER_CREDIT. */
    /** public static final String TRANSFER_CREDIT = "TRANSFER_CREDIT"; */

    /** The Constant CASH_ADVANCE. */

...
public class OkHttpGetRequestEncryptionHeaderInterceptor implements Interceptor {
    ...
    protected Request addEncryptionHeaders(Request request) throws ReferenceAppGenericException {
        ...
        if (config.getDecryptionKey() == null) {
            ...
            updateHeader(requestBuilder, PUBLIC_KEY_FINGERPRINT_HEADER, config.getEncryptionCertificateFingerprint());
            updateHeader(requestBuilder, OAEP_HASHING_ALGORITHM_HEADER, params.getOaepPaddingDigestAlgorithmValue());
